# DineSalida.com — Salida, CO Restaurant Guide
...
DineSalida.com is a Colorado tourism directory site focused on dining in Salida, CO — farm-to-table restaurants, craft breweries, mountain cuisine, and cafes. Part of the Wave 8 directory site build sprint (S129).

- **Location in APPS:** `~/Documents/APPS/_new-projects/dinesalida/`
- **GitHub:** https://github.com/Trace9095/dine-salida
- **Branch:** main
- **Production URL:** dinesalida.com
- **Vercel Slug:** `dine-salida`
- **Version:** 0.1.0
...
- **DNS:** dinesalida.com — A: 76.76.21.21, CNAME www: cname.vercel-dns.com (configured S129)
...
├── packages/
│   └── shared/        ← Shared types (@dinesalida/shared)
├── turbo.json
└── package.json
```
...
| `/restaurants` | Restaurants directory listing |
| `/blog` | Blog / content |
| `/pricing` | Business listing pricing ($99/mo minimum) |
| `/request-listing` | Business listing request form |
...
- **Theme:** Dark #0D1117 background, Evergreen/amber color scheme
- **Font:** Geist Sans + Geist Mono
- **Icons:** Lucide React (no emojis)
- **Style:** Mountain dining guide — fresh, alpine, Salida's outdoor/arts scene
...
4. **Fritz Restaurant Salida is CLOSED — never list it** (permanent exclusion)
5. Every external URL tested before deploy
6. Real photos from real businesses only — no stock photos
7. Evergreen/amber color scheme — must look independent from other directory sites
8. **The Edge Zip is NOT listed** on any directory site (permanent exclusion)
...
115e118 feat: add icon.tsx and apple-icon.tsx favicons
...
- ✅ Pricing corrected to $99/mo minimum
- ✅ DNS configured (dinesalida.com → Vercel)
- ✅ EAS config added
...
5. Verify Fritz Restaurant not listed (permanently closed)

## Environment Variables

```
DATABASE_URL=                # Neon PostgreSQL (via Vercel Storage integration)
NEXT_PUBLIC_APP_URL=         # https://dinesalida.com
...
- **Repo:** https://github.com/Trace9095/dine-salida
